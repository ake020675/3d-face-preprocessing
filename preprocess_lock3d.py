...
def o3d_fill_holes(depth):
    ...
    for i in range(h):
        for j in range(w):
            ...
            if points[n][2] < 0.4 or points[n][2] > 0.9:
                points[n][2] = 0

            points[n][1] = (i-camera_cy)*points[n][2]/camera_fy  # *points[n][2]/camera_fy
            points[n][0] = (j-camera_cx)*points[n][2]/camera_fx  # *points[n][2]/camera_fx
            n = n + 1
...
if __name__ == '__main__':
    ...
    # rgb_file = r'C:\Users\liang\Desktop\projects\Lock3D-preprocessing\a001.png'
    # depth_file = r'C:\Users\liang\Desktop\projects\Lock3D-preprocessing\a001.dat'
    # rgb_face = cv2.imread(rgb_file)
    # depth_face = np.loadtxt(depth_file)

    rgb_file = r'/home/xt/zk/XJTU_DATA_2023_part1-4/record20231224083748/11309581-20231224080915/rgb.png'
    depth_file = r'/home/xt/zk/XJTU_DATA_2023_part1-4/record20231224083748/11309581-20231224080915/data.bin'
    ...
    dat_nose_tip[0] = round(nose_tip[0])
    dat_nose_tip[1] = round(nose_tip[1])

    if len(faces) != 1:
        print("multi face detected")

    r = 80
    roi_rgb = rgb_face[dat_nose_tip[1] - r:dat_nose_tip[1] + r,
    ...
    x0 = int(resize / 2)
    y0 = int(resize / 2)
    z0 = np.median(roi_face[x0 - 11:x0 + 10, y0 - 11:y0 + 10])

    roi_nose = roi_face[x0 - 11:x0 + 10, y0 - 11:y0 + 10]
    # z0 = 578.9344  # for debug
    ...
    cv2.imshow('cropped', depth)
    cv2.waitKey()
    cv2.imwrite('cropped.png', -1.0 * depth)
